...
switch using_cluster
    case 'none'
        ...
        datapath = ['C:\Users\pare0001\OneDrive - Nanyang Technological University\Codes\CC-OPF Related\CCC-Solver\data\',casename,'\',distribution,'\'];
        resultpath = ['C:\Users\pare0001\OneDrive - Nanyang Technological University\Codes\CC-OPF Related\CCC-Solver\results\',casename,'\',distribution,'\'];
    case 'terra'
...
elseif have_fcn('mosek')
    disp('have mosek');
    opt_yalmip = sdpsettings(opt_yalmip,'solver','sedumi','verbose',2);
else
...
if using_optimizer
    ...
    for iMC = 1:nMC
        ...
        sol = optimize([constr_det; constr_prob],objective,opt);    
        disp(sol.info);
